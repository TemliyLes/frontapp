  ...
  <aside :class="[
    ...
    <div class="flex flex-col h-full grow">
      ...
      <div class="flex-1 overflow-y-auto">
        <UNavigationMenu orientation="vertical" class="px-2" :class="isCollapsed ? 'grid place-items-center' : ''"
          :items="navLinks" :collapsed="isCollapsed" :ui="{
            linkLeadingIcon: !isCollapsed ? 'text-lg' : 'text-2xl'
          }" />
      </div>
